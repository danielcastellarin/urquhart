...
using BoostGraph = adjacency_list<vecS, vecS, bidirectionalS, hype_urq::EpicPolygon>;
...
namespace hype_urq {
    ...
    class Tree {
        public:
            explicit Tree(const std::vector<EpicPolygon>& polygons);
            void view_tree();
            ...
            BoostVertexT merge_op(BoostVertexT i, BoostVertexT j, const EpicPolygon& data);
            EpicPolygon get_vertex(const BoostVertexT v);
